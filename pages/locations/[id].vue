<template >
    ...
    <div v-if='formData'>
        <form @submit.prevent="updateDetails" method="post" enctype="multipart/form-data" class="space-y-6 mb-8 mx-4 mt-4 max-h-[70vh] overflow-y-auto">
     ...
     v-for="[key, value] in Object.entries(locationInfo).filter(([key]) => key !== 'index')" 
     :key="key">
    <p>
        <strong>
...
<script setup lang="ts">
    ...
    if(formData.value){
        ...
        axios.put(`${apiBase}/locations/${locationId}`, formData.value)
